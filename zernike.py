...
if __name__ in '__main__':
    ...
    coeffs = {
                                                     'Z00':0.5,
                                                'Z1m1':0.0, 'Z11':0.0,
                                        'Z2m2':-0.3, 'Z20':1.0, 'Z22':-.5,
                                    'Z3m3':0.0, 'Z3m1':1.0, 'Z31':0.0, 'Z33':0.0,
                             'Z4m4':1.0, 'Z4m2':0.0, 'Z40':2.00, 'Z42':0.0, 'Z44':0.0,
                        'Z5m5':0.0, 'Z5m3':0.0, 'Z5m1':0.0, 'Z51':0.0, 'Z53':0.0, 'Z55':0.0,
                 'Z6m6':-0.5, 'Z6m4':0.0, 'Z6m2':0.0, 'Z60':0.0, 'Z62':0.0, 'Z64':0.0, 'Z66':0.0,
            'Z7m7':0.0, 'Z7m5':0.0, 'Z7m3':0.0, 'Z7m1':0.0, 'Z71':0.0, 'Z73':0.0, 'Z75':0.0, 'Z77':0.0,
     'Z8m8':0.0, 'Z8m6':0.0, 'Z8m4':0.0, 'Z8m2':0.0, 'Z80':-1.0, 'Z82':0.0, 'Z84':0.0, 'Z86':0.0, 'Z88':0.0,
    }
    
    test = zernike_expansion(R, T, coeffs)

    plt.figure()
    ax = plt.subplot(111, polar=True)
    ax.pcolor(T, R, test, cmap='RdBu', shading='auto')
    ax.set_yticks([])
    ax.set_xticks([])
    plt.show()
